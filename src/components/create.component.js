...
export default class Create extends Component {
  ...
  onSubmit(e) {
    ...
    axios.post('http://localhost:4000/user/add', obj)
        .then(res => {
          ...
          if("user" in res.data)
          {
            this.setState({on_success: 'New User Has Been Added to the Database'})
          }
        })
  ...
  //  https://postit.lt/user/c7e44ea9269234e5a9a4bd7ae074b367dfcb20da/keys/88/
  //  https://postit.lt/API/
  //  https://postit.lt/example/1/
  setZipCode(){
   ...
   // const url = 'https://postit.lt/data/?address=' + middlePart + ',+' + city + '&key=postit.lt-examplekey';
